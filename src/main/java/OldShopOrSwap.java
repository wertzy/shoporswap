...
public class OldShopOrSwap implements BasicAPI{
     ...
     */
    public OldShopOrSwap(List<User> users){
        // implement method to pass corresponding tests after the tests have been written
     ...
     */
    public OldShopOrSwap(List<User> users, List<Product> products){
        // implement method to pass corresponding tests after the tests have been written
        if(!isValidUserList(users)){
            throw new IllegalArgumentException("List of Users to import is invalid");
        }
     ...
     */
    public OldShopOrSwap(String dataFile) throws IOException {
        OldShopOrSwap dataOldShopOrSwap = JsonUtil.fromJsonFile(dataFile, OldShopOrSwap.class);
        this.userList = dataOldShopOrSwap.getUserList();
        this.productList = dataOldShopOrSwap.getProductList();
    }
