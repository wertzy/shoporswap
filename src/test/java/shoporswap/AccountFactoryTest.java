...
public class AccountFactoryTest {
    ...
    /**
     * Automated tests for shoporswap.AccountFactory.getAccount method
     */
    @Test
    void getAccountTest(){
        ...
        assertThrows(IllegalArgumentException.class, ()-> testAccountFactory.getAccount("shoporswap.Admin "));
