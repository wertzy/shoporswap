...
public class AbstractProductTest {
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.isValidProductName method
     */
    @Test
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.isValidProductDescription method
     */
    @Test
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.isValidProductPrice method
     */
    @Test
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.addTag methods (one with shoporswap.Tag object argument, one with String argument)
     */
    @Test
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.findTag methods (one with shoporswap.Tag object argument, one with String argument)
     */
    @Test
    void findTagTestTagTests(){
        ...
        assertThrows(NoSuchElementException.class, ()-> testSellProduct1.findTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSellProduct2.findTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSwapProduct3.findTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSwapProduct4.findTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
    ...
    /**
     * Automated tests for shoporswap.AbstractProduct.removeTag methods (one with shoporswap.Tag object argument, one with String argument)
     */
    @Test
    void removeTagTestsTagTest(){
        ...
        assertThrows(NoSuchElementException.class, ()-> testSellProduct1.removeTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSellProduct2.removeTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSwapProduct3.removeTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
        ...
        assertThrows(NoSuchElementException.class, ()-> testSwapProduct4.removeTag(new Tag("tag1"))); // Equivalence class: tag must already be attached to shoporswap.SellProduct (invalid case)
