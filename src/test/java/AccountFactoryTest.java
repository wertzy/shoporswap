...
public class AccountFactoryTest {
    ...
    void getAccountTest(){
        ...
        assertEquals("DefaultName", testAdminAccount1.getAccountName());
        ...
        assertEquals("DefaultName", testAdminAccount2.getAccountName());
        ...
        assertEquals("DefaultName", testAdminAccount3.getAccountName());
        ...
        assertEquals("DefaultName", testClientAccount1.getAccountName());
        ...
        assertEquals("DefaultName", testClientAccount2.getAccountName());
        ...
        assertEquals("DefaultName", testClientAccount3.getAccountName());
